/* Ícones SVG inline (substituto do lucide-react, sem biblioteca).
   Cada entrada guarda apenas os <path>s; a função Icon() monta o <svg>.
   Estilo lucide: stroke=currentColor, 24x24, cantos arredondados. */
window.IconPaths = {
  ...
  CalendarClock: '<path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7.5"/><path d="M16 2v4"/><path d="M8 2v4"/><circle cx="16" cy="16" r="6"/><path d="M16 14v2l1 1"/>',
  ...
  BarChart3: '<path d="M3 3v18h18"/><rect width="4" height="9" x="7" y="9" rx="1"/><rect width="4" height="5" x="13" y="13" rx="1"/><rect width="4" height="13" x="3" y="5" rx="1"/><rect width="4" height="7" x="17" y="11" rx="1"/>',
  ...
  Wallet: '<path d="M19 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0 0 4h14a2 2 0 0 1 0 4h-3a2 2 0 0 0 0 4h3a2 2 0 0 0 2-2v-2"/><path d="M21 12a2 2 0 0 0-2-2h-3a2 2 0 0 0 0 4h3a2 2 0 0 0 2-2Z"/>',
  ClipboardList: '<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="m9 14 2 2 4-4"/>',
};

window.Icon = function (name, size) {
  size = size || 20;
  var paths = window.IconPaths[name] || '';
